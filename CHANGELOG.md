...
- **Long-task hook is now tested** end-to-end (drip cadence, distinctness, the 5-crumb cap, stop-on-return, `minTaskMs` gating, non-long tools) via a fake host + mock timers.
